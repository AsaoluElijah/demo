<?php
    ...
    //     $newLogin = $create->register($email,$password);
    //     if ($newLogin === 'true') {
    //         $success = true;
    //     }else {
    //         $failed = true;
    	...
    	<div class="row">
        	<div class="col-lg-12">
                    ...
                    <div class="field_form authorize_form">
                    	<form>
                            ...
                            <div class="form-group col-md-12 animation" data-animation="fadeInUp" data-animation-delay="0.7s">
                            	<input type="number" class="form-control" required="" placeholder="Mobile Number" name="phone">
                            </div>
                            ...
                            <div class="form-group col-md-12 animation" data-animation="fadeInUp" data-animation-delay="0.9s">
                            	<div class="checkbox_field d-inline">
                                    ...
                                    <label for="rememberme">I agree with <a href="#">Terms of Services</a></label>
                                </div>
                            </div>
                            <div class="form-group col-md-12 text-center animation" data-animation="fadeInUp" data-animation-delay="1s">
                            	<button class="btn btn-default btn-radius" type="submit" name="submit">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="text-center">
                    <span class="animation" data-animation="fadeInUp" data-animation-delay="1s">Already have an account? <a href="signin.php"> Login</a></span>
                </div>
            </div>
        </div>
    </div>
