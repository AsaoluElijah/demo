...
<!-- Mirrored from bestwebcreator.com/cryptocash/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 May 2019 19:20:03 GMT -->
<head>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12 order-lg-first">
                <div class="banner_text text_md_center">
                    <h1 class="animation" data-animation="fadeInUp" data-animation-delay="1.1s">Priceless helps you top-up data and airitme the easy way.</h1>
                    <p class="animation" data-animation="fadeInUp" data-animation-delay="1.2s">Priceless is a platfrom where you can get,share and top-up your airtime or data subscription the easy way, using <b>Blue-coin</b> token or payment with your card </p>
                    <div class="btn_group animation" data-animation="fadeInUp" data-animation-delay="1.3s"> 
                        <a href="#airtime" class="btn btn-default nav-link content-popup">Buy Airtime <i class="ion-ios-arrow-thin-right"></i></a> 
                        <a href="#data" class="btn btn-border nav-link content-popup">Buy Data <i class="ion-ios-arrow-thin-right"></i></a> 
                    </div>
                    <!-- Popup for airtime -->
                    <div id="airtime" class="team_pop mfp-hide">
                        <div class="row m-0">
                            <div class="col-md-7">
                                <div class="pt-3 pb-3">
                    ...
                    <!-- Popup for data -->
                    <div id="data" class="team_pop mfp-hide">
                        <div class="row m-0">
                            <div class="col-md-7">
                                <div class="pt-3 pb-3">
                                    <div class="title_default_dark title_border"> 
            	...
            	<div class="token_rtinfo bg-white-tran box_shadow_none border_right m-0">
                	<div class="row text-center">
                    	<div class="col-lg-2 col-md-4 col-6">
                        	<div class="token_rt_value token_value_white animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                            	<h3>4.7<span>/5</span></h3>
                                <p>ICO Bench</p>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                        	<div class="token_rt_value token_value_white animation" data-animation="fadeInUp" data-animation-delay="0.4s">
                            	<h3>9.5<span>/5</span></h3>
                                <p>ICO Marks</p>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                        	<div class="token_rt_value token_value_white animation" data-animation="fadeInUp" data-animation-delay="0.6s">
                            	<h3>4.1<span>/5</span></h3>
                                <p>ICO Bazaar</p>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                        	<div class="token_rt_value token_value_white animation" data-animation="fadeInUp" data-animation-delay="0.8s">
                            	<h3>4.0<span>/5</span></h3>
                                <p>ICO Ranker</p>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                        	<div class="token_rt_value token_value_white animation" data-animation="fadeInUp" data-animation-delay="1s">
                            	<h3>4.6<span>/5</span></h3>
                                <p>ICO Track</p>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-4 col-6">
                        	<div class="token_rt_value token_value_white animation" data-animation="fadeInUp" data-animation-delay="1.2s">
...
<section class="about_shape_bg">
		...
		<div class="row align-items-center">
			<div class="col-lg-8 offset-lg-2 col-md-12 col-sm-12">
				<div class="title_default_dark title_border text-center">
                  <h4 class="animation" data-animation="fadeInUp" data-animation-delay="0.2s">About Blue-Coin</h4>
                  ...
                  <a href="about.html" class="btn btn-info box_shadow animation" data-animation="fadeInUp" data-animation-delay="0.6s">Read More <i class="ion-ios-arrow-thin-right"></i></a>
        		</div>
			</div>
        </div>
        ...
        <div class="row">
        	<div class="col-lg-4">
            	<div class="title_default_dark title_border">
                    ...
                    <a href="https://www.youtube.com/watch?v=ZE2HxTmxfrI" class="btn btn-default video animation" data-animation="fadeInUp" data-animation-delay="0.6s"><em class="ion-play"></em>Let's Start</a>
                </div>
            </div>
            <div class="col-lg-8">
            	<div class="row">
                	<div class="col-lg-6">
                    	<div class="work_box res_md_mt_20">
                            ...
                            <div class="work_inner">
                            	<h4 class="animation" data-animation="fadeInUp" data-animation-delay="0.3s">Register an account</h4>
                    ...
                    <div class="col-lg-6">
                    	<div class="work_box res_md_mt_20">
                            ...
                            <div class="work_inner">
                            	<h4 class="animation" data-animation="fadeInUp" data-animation-delay="0.3s">Buy Data</h4>
                    ...
                    <div class="col-lg-6">
                    	<div class="work_box mt-4">
                            ...
                            <div class="work_inner">
                            	<h4 class="animation" data-animation="fadeInUp" data-animation-delay="0.3s">Buy Airtime</h4>
                    ...
                    <div class="col-lg-6">
                    	<div class="work_box mt-4">
                            ...
                            <div class="work_inner">
                            	<h4 class="animation" data-animation="fadeInUp" data-animation-delay="0.3s">Share the love <i class="ion-heart"></i></h4>
    ...
    <div class="rounded_shape"></div>
</section>
<!-- END SECTION ABOUT --> 

<!-- START SECTION TOKEN SALE -->
<section class="section_token blue_light_bg" data-z-index="1" data-bleed="-40" data-parallax="scroll" data-image-src="assets/images/token_bg.png">
            	...
            	<div class="token_sale">
                    <div class="tk_countdown text-center animation token_countdown_bg" data-animation="fadeIn" data-animation-delay="1s">
                        <div class="tk_counter_inner">
                            <div class="tk_countdown_time animation" data-animation="fadeInUp" data-animation-delay="1.2s" data-time="2019/08/08 00:00:00"></div>
                        	...
                        	<a href="#" class="btn btn-default animation" data-animation="fadeInUp" data-animation-delay="1.4s">Buy Tokens <i class="ion-ios-arrow-thin-right"></i></a>
          	...
          	<div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 pl-2 pr-2">
                    <div class="pr_box">
                      ...
                      <p  class="animation" data-animation="fadeInUp" data-animation-delay="1.2s">1 ETH = 820 BCC, 1 BTC = 2150 BCC</p>
                    </div>
                  </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 pl-2 pr-2">
                    <div class="pr_box">
	...
	<div class="container">
    	<div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-12 col-sm-12">
                <div class="res_md_mt_50 res_sm_mt_20 text-center animation" data-animation="fadeInRight" data-animation-delay="0.2s"> 
    ...
    <div class="container">
        ...
        <div class="row">
        	<div class="col-md-12 text-center">
            	<a href="team.html" class="btn btn-default animation" data-animation="fadeInUp" data-animation-delay="0.2s">View All Team <i class="ion-ios-arrow-thin-right"></i></a>
            </div>
        </div>
    </div>
    <div class="divider large_divider"></div>
...
<!-- START SECTION BLOG -->
<section class="blue_light_bg" data-bleed="-40" data-z-index="1" data-parallax="scroll" data-image-src="assets/images/roadmap_bg.png">
    <div class="angle_top"></div>
    <div class="divider large_divider"></div>
	<div class="container">
    	<div class="row">
        ...
        <div class="row">
        	<div class="col-md-12 text-center">
            	<a href="blog-right-sidebar.html" class="btn btn-default animation" data-animation="fadeInUp" data-animation-delay="0.2s">View All News <i class="ion-ios-arrow-thin-right"></i></a>
            </div>
        </div>
    </div>
    <div class="divider large_divider"></div>
                        ...
                        <form method="post" name="enq" class="field_form_s2">
                            <div class="row">
                                ...
                                <div class="col-md-12 text-center animation" data-animation="fadeInUp" data-animation-delay="1.4s">
                                	<button type="submit" title="Submit Your Message!" class="btn btn-default btn-block" id="submitButton" name="submit" value="Submit">Submit <i class="ion-ios-arrow-thin-right"></i></button>
                                </div>
                                <div class="col-md-12">
...
<!-- Mirrored from bestwebcreator.com/cryptocash/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 May 2019 19:21:34 GMT -->
</html>